  ...
  return (
    <div className={className}>
      <div className="flex items-center justify-center gap-4">
        ...
        <div className="flex flex-col items-center gap-2">
          ...
          <div className="flex flex-col items-center gap-2">
            <Button
              ...
              className="h-10 w-20 rounded-lg bg-secondary hover:bg-secondary/80"
            >
            ...
            <Input
              ...
              className="h-20 w-20 text-center text-2xl font-bold bg-secondary border-0 focus-visible:ring-2"
            />
            <Button
              variant="outline"
              size="icon"
        ...
        {/* Separator */}
        <span className="text-4xl font-bold self-center" style={{ marginTop: '2rem' }}>:</span>
